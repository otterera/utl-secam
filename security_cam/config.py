...
class Config:
    ...
    EXP_DARK_MEAN_EXIT = float(os.getenv("SC_EXP_DARK_MEAN_EXIT", 70))
    ...
    ENHANCE_UNDER_ALPHA = float(os.getenv("SC_ENHANCE_UNDER_ALPHA", 3.0))  # Contrast/gain multiplier
    ENHANCE_UNDER_BETA = float(os.getenv("SC_ENHANCE_UNDER_BETA", 30))  # Brightness offset (0..255)
    ...
    AE_EV_STEP = float(os.getenv("SC_AE_EV_STEP", 0.3))  # Per adjustment step
